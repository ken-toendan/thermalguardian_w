...
export const content = {
  ...
  how: {
    ...
    diagramNodes: {
      ...
      hubSub1: { en: "On-device processing", ja: "オンデバイス処理" },
      hubSub2: { en: "Stage-aware state engine", ja: "段階対応ステートエンジン" },
      hubSub3: { en: "Safety rule set", ja: "安全ルールセット" },
      cloud: { en: "Cloud Database", ja: "クラウド DB" },
      cloudSub1: { en: "Encrypted cloud storage", ja: "暗号化クラウドストレージ" },
